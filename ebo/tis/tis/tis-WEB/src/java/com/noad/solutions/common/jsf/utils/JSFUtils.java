...
public class JSFUtils {
     ...
     * <code>FacesMesssage</code> from a defined error key and severity This
     * assumes that the error keys follow the convention of using <b>_detail</b>
     * for the detailed part of the message, otherwise the main message is
     * returned for the detail as well.
     *
